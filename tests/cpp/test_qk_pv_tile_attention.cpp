...
void test_qk_pv_matches_standard(flashone::TileKernelKind qk_kind,
    ...
    const auto actual = flashone::flash_attention_qk_pv_tile(q, k, v, shape, options);
...
int main() {
    test_qk_pv_matches_standard(flashone::TileKernelKind::Reference,
                                flashone::TileKernelKind::Reference);
#ifdef FLASHONE_HAS_ONEDNN
    test_qk_pv_matches_standard(flashone::TileKernelKind::OneDnn,
                                flashone::TileKernelKind::Reference);
    test_qk_pv_matches_standard(flashone::TileKernelKind::Reference,
    ...
    test_qk_pv_matches_standard(flashone::TileKernelKind::OneDnn,
                                flashone::TileKernelKind::OneDnn);
#endif
    std::cout << "flashone QK/PV tile attention tests passed\n";
    return 0;
}
