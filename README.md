...
```text
include/onednn_flash/  Public C++ headers
src/onednn_flash/      C++ implementation
python/onednn_flash/   Python reference/golden code
tests/cpp/             C++ tests
...
See `docs/design/project-plan.md` for the full two-phase plan:
